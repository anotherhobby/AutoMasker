...
# label2 = M5TextBox(10, 50, "", lcd.FONT_DejaVu18,0xFFFFFF, rotate=0)
label3 = M5TextBox(10, 50, "Last:", lcd.FONT_Ubuntu,0xFFFFFF, rotate=0)
...
# calculate the wideth of the screen for agiven ratio
